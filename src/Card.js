...
function Card({
  ...
  if (type === "/Fee") {
    states = [value1, value2, value5,value8];
    setStates = [setValue1, setValue2, setValue5,setValue8];
    values2 = [values[0], values[1], values[4],values[7]];
    labels2 = [labels[0], labels[1], labels[4],labels[7]];
  }

  if (type === "/Driver") {
    states = [value1, value2, value3,value4,value5,value6,value7];
    setStates = [setValue1, setValue2, setValue3,setValue4,setValue5,setValue6,setValue7];
    values2 = [values[0], values[1], values[2],values[3], values[4], values[5],values[6]];
    labels2 = [labels[0], labels[1], labels[2],labels[3], labels[4], labels[5],labels[6]];
  }
  ...
  const updateElement = () => {
    ...
    if (type === "/Fee") {
        console.log(value8)
      bodyy = { taxidriver: value1, amount: value2, user: user, car: value5,date: value8 };
    }
    if (type === "/Driver") {
        let status = 0;
        if(value7 === "Activo"){
        ...
        bodyy = { fn: value1, sn: value2, ln: value3, alias:value4,ID:value5, car:value6, status: status };
      }
      if(type === '/Repair'){
      ...
      if (type === "/Car") {
        ...
        bodyy = { registration: value1, model: value2, status: status, driver:value4, user:user };
      }
